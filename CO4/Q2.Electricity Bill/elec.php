...
<body>
    ...
    echo '<table width="40%" border="0" cellspacing="0" cellpadding="10"><tr><th colspan="2"><h2>ELECTRICITY BILL</h2></th></tr>';
    echo "<tr><td>Consumer Number</td><td>$consumer_number</td></tr>";
    echo "<tr><td>Customer Name</td><td>$consumer_name</td></tr>";
    echo "<tr><td>Previous Reading</td><td>$previous_reading</td></tr>";
    echo "<tr><td>Present Reading</td><td>$present_reading</td></tr>";
    echo "<tr><td>Unit consumed</td><td>$unit</td></tr>";
